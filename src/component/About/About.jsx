      ...
      <Box sx={{
        ...
        <Box sx={{
          ...
          <Box sx={{
            ...
            <Typography variant='h4' fontWeight="bold">I'm <span style={{
              color: "#20c997",
              lineHeight: "3em"
            }}>Abdullah Tayyab</span>, a Web Developer</Typography>
            <Typography color="#4C4D4D" lineHeight="2em">I'm a Mern Stack Front-end web developer. I've 6 months of experience in HTML, CSS, JavaScript, ReactJS, Redux, MUI and complete different projects.</Typography>
          </Box>
          <Box sx={{
            maxWidth: "300px",
            marginTop: "30px"
